...
const int KNIGHT_VALUE = 404, KNIGHT_VALUE_EG = 407;
const int BISHOP_VALUE = 419, BISHOP_VALUE_EG = 420;
const int ROOK_VALUE = 645, ROOK_VALUE_EG = 652;
const int QUEEN_VALUE = 1248, QUEEN_VALUE_EG = 1252;
